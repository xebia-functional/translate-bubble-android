...
class TranslateServiceComponentSpec
  ...
  "TranslateService component" should {
    ...
    "TranslateService should get None when json is invalid" in new TranslateMocks {
